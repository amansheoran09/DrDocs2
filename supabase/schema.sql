-- DocVault — consolidated schema for a HOSTED Supabase project.
-- Paste this whole file into the Supabase SQL Editor and Run, then run
-- supabase/seed.sql the same way. Excludes the local-only 0000 shim
-- (Supabase already provides the auth schema, roles and auth.uid()).
-- Generated from supabase/migrations/0001..0011 — do not edit by hand.
